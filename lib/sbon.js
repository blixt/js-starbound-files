 ...
 */
Reader.prototype.readBytes = function (count, opt_noCopy) {
...
Reader.prototype.readByteString = function (length) {
  return String.fromCharCode.apply(null, this.readBytes(length, true));
};

Reader.prototype.readDocument = function () {
...
Reader.prototype.readDocumentList = function () {
 ...
 * at the first null.
 */
Reader.prototype.readFixedString = function (length) {
...
Reader.prototype.readIntVar = function () {
...
Reader.prototype.readStringList = function () {
...
Reader.prototype.readUintVar = function () {
  var value = 0;
  while (true) {
...
Reader.prototype.seek = function (offset, opt_relative) {
